...
3. 对于您自行上传的全部文案内容，本站不拥有所有权，也不承担任何法律责任。您理解并同意，由您上传的内容所引发的一切争议、损失或损害，均与本站无关。
4. 本站保留在任何时候对您上传至服务器的文案内容进行修改、移动或删除的权利，无需事先通知。这些操作可能基于但不限于以下原因：内容涉嫌违法、侵权、违规，或者为了保持网站正常运行和维护服务质量。
5. 隐私方面，注册登录仅用于记录和统计输入速度，您完全可以不用登陆而使用所有功能。您注册的密码也已进行单向 Hash 加密（[bcrypt](https://github.com/dcodeIO/bcrypt.js#readme)），不可反向破解生成密码明文，意思是本站也无法知道具体密码内容。
6. 本站仅学习交流使用，无商业用途。
7. 最终解释权归本站所有。
...
## 源码
[Github](https://github.com/YasinChan/typing)
